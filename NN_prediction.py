# -*- enconding: utf-8 -*-
# @ModuleName: NN_prediction
# @Function:
# @Author: Yanzhan Chen
# @Time: 2021/6/21 15:49
...
class SVR_model():
    ...
    def train(self,target):
        ...
        # model = MLPRegressor(hidden_layer_sizes=(90,60,30,15,5), activation="relu",
        #                      solver='adam', alpha=0.0001,
        #                      batch_size='auto', learning_rate="constant",
        #                      learning_rate_init=0.01, power_t=0.5, max_iter=2000)
        model = MLPRegressor(hidden_layer_sizes=(8,4), activation="relu",
                             solver='adam', alpha=0.0001,
                             batch_size='auto', learning_rate="constant",
                             learning_rate_init=0.01, power_t=0.5, max_iter=200)
